...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QtGui.QFontDatabase.addApplicationFont(os.getcwd() + '\\' + 'custom_font' + '\\' + 'EchoRevival.otf')
        font = QFont("EchoRevival", 20)
        ...
        font_button = QFont("Times", 13, QFont.Bold)
        self.patientButton.setFont(font_button)
        font_button = QFont("Times", 10, QFont.Bold)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.inh_4.setText(_translate("MainWindow", "Деталзация ингаляции"))
